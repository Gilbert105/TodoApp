...
val MIGRATION_2_3= object  :Migration(2,3) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        //menurut saya menggunakan Integer karena di dalam database Boolean disimpan dalam tipe TinyInt
        //Jadi sebaiknya langsung diinputkan dengan Tipe Int Dibandingkan
        //Boolean karena boolean perlu diconvert terlebih dahulu
    }
}